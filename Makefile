...
CORE_SRCS := core/format.c core/console.c core/halt.c core/memmap.c \
             ...
             core/log_sink.c core/log_split.c core/disk_inventory.c core/cpu_topology.c core/smp_pack.c core/e1000.c core/e1000_hw.c core/arp.c core/pe_ident.c core/mtrr.c
...
MICRO_NAMES := hello faulter ram1 cpumsr fwcfg intdeliver pausespin ps2 pflash pci ramfb virtioblk ahci atadisk bochsvbe
