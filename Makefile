...
CORE_SRCS := core/format.c core/console.c core/halt.c core/memmap.c \
             ...
             core/gpt.c core/iso_stream.c core/fat.c core/file_range.c core/fs_ops.c core/ntfs.c core/ext2_alloc.c core/jbd2.c core/ext_jalloc.c core/ext_csum.c core/ext.c core/ext_write.c core/blk_image.c core/blk_qcow2.c core/nvme_host.c core/nvme_host_hw.c core/blk_backend.c core/blk_phys.c core/blk_phys_hw.c core/phys_guard.c \
...
DEVICE_SRCS := devices/pic.c devices/pit.c devices/hpet.c devices/smbios.c devices/pflash.c devices/acpi.c devices/acpi_loader.c \
               ...
               devices/xhci_dev.c devices/usb_msc.c devices/usb_passthru.c
...
MICRO_NAMES := hello faulter ram1 cpumsr fwcfg intdeliver pausespin ps2 pflash pci ramfb virtioblk ahci atadisk bochsvbe virtionet netdns netpeer netgoal e1000dns logchatter
