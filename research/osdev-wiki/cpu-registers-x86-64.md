---
title: 'CPU Registers x86-64'
source_page_id: '3774'
source_revision_id: '30266'
source_timestamp: '2026-03-16T17:44:07Z'
...
|-
| colspan=2 | 12-63
| colspan=2 | Physical Base Address of the PML4
|-
|}
...
## MSRs
#### IA32_EFER
Extended Feature Enable Register (EFER) is a [register](model-specific)(MSR) added in the AMD K6 processor, to allow enabling the SYSCALL/SYSRET instruction, and later for entering and exiting [mode](long)(x86-64). This register becomes architectural in [AMD64](AMD64) and has been adopted by Intel. Its MSR number is 0xC0000080.
...
|}
<blockquote>
Table from https://wiki.jwo.cz/index.php?title=IA32_EFER.</blockquote>
...
! 32-bit
|-
| colspan="2" style="text-align:center" |Bits 0-15
|Limit
|Size of [GDT](GDT)
|-
| Bits 16-79
...
[Registers](Category:CPU)(Category:CPU Registers)
